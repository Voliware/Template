...
var BootstrapControlTable = function (_ControlTable) {
  ...
  */
	function BootstrapControlTable(options) {
		...
		var _this16 = _possibleConstructorReturn(this, (BootstrapControlTable.__proto__ || Object.getPrototypeOf(BootstrapControlTable)).call(this, options));
  ...
  */
	...
	_createClass(BootstrapControlTable, [{
		key: "_createDeleteButton",
		value: function _createDeleteButton(data) {
			var $btn = _get2(BootstrapControlTable.prototype.__proto__ || Object.getPrototypeOf(BootstrapControlTable.prototype), "_createDeleteButton", this).call(this, data);
   ...
   */
		...
		key: "_createUpdateButton",
		value: function _createUpdateButton(data) {
			var $btn = _get2(BootstrapControlTable.prototype.__proto__ || Object.getPrototypeOf(BootstrapControlTable.prototype), "_createUpdateButton", this).call(this, data);
			$btn.addClass('btn btn-default');
   ...
   */
		...
		key: "_createViewButton",
		value: function _createViewButton(data) {
			var $btn = _get2(BootstrapControlTable.prototype.__proto__ || Object.getPrototypeOf(BootstrapControlTable.prototype), "_createViewButton", this).call(this, data);
			$btn.addClass('btn btn-default');
...
var BootstrapFeedback = function (_Feedback) {
  ...
  */
	function BootstrapFeedback(options) {
		...
		var _this17 = _possibleConstructorReturn(this, (BootstrapFeedback.__proto__ || Object.getPrototypeOf(BootstrapFeedback)).call(this, options));

		var self = _this17;

		if (_this17.settings.closeButton) {
			_this17.$close.click(function () {
				self.slideUp();
			});
		}
...
var BootstrapFormGroup = function (_FormGroup) {
  ...
  */
	function BootstrapFormGroup(options) {
		...
		var _this18 = _possibleConstructorReturn(this, (BootstrapFormGroup.__proto__ || Object.getPrototypeOf(BootstrapFormGroup)).call(this, $Util.opts(defaults, options)));
...
var BootstrapFormGroupManager = function (_FormGroupManager) {
  ...
  */
	function BootstrapFormGroupManager(options) {
		...
		var _this19 = _possibleConstructorReturn(this, (BootstrapFormGroupManager.__proto__ || Object.getPrototypeOf(BootstrapFormGroupManager)).call(this, $Util.opts(defaults, options)));
...
var BootstrapFormInput = function (_FormInput2) {
	_inherits(BootstrapFormInput, _FormInput2);
  ...
  */
	function BootstrapFormInput(data, options) {
		...
		var _this20 = _possibleConstructorReturn(this, (BootstrapFormInput.__proto__ || Object.getPrototypeOf(BootstrapFormInput)).call(this, data, options));
...
var BootstrapFormSelect = function (_FormSelect) {
  ...
  */
	function BootstrapFormSelect(data, options) {
		...
		var _this21 = _possibleConstructorReturn(this, (BootstrapFormSelect.__proto__ || Object.getPrototypeOf(BootstrapFormSelect)).call(this, data, options));
...
var BootstrapForm = function (_Form2) {
	_inherits(BootstrapForm, _Form2);
  ...
  */
	function BootstrapForm(options) {
		...
		var _this22 = _possibleConstructorReturn(this, (BootstrapForm.__proto__ || Object.getPrototypeOf(BootstrapForm)).call(this, $Util.opts(defaults, options, 'replace')));

		return _ret22 = _this22, _possibleConstructorReturn(_this22, _ret22);
	}
...
var BootstrapModal = function (_Template8) {
	_inherits(BootstrapModal, _Template8);
  ...
  */
	function BootstrapModal(options) {
		...
		var _this23 = _possibleConstructorReturn(this, (BootstrapModal.__proto__ || Object.getPrototypeOf(BootstrapModal)).call(this, $Util.opts(defaults, options)));

		return _ret23 = _this23, _possibleConstructorReturn(_this23, _ret23);
	}
...
var BootstrapModalForm = function (_BootstrapModal) {
  ...
  */
	function BootstrapModalForm(options) {
		...
		// properties
		var _this24 = _possibleConstructorReturn(this, (BootstrapModalForm.__proto__ || Object.getPrototypeOf(BootstrapModalForm)).call(this, options));

		_this24.form = null;

		return _ret24 = _this24, _possibleConstructorReturn(_this24, _ret24);
	}
...
var BootstrapNav = function (_Template9) {
	_inherits(BootstrapNav, _Template9);
  ...
  */
	function BootstrapNav(options) {
		...
		var _this25 = _possibleConstructorReturn(this, (BootstrapNav.__proto__ || Object.getPrototypeOf(BootstrapNav)).call(this, $Util.opts(defaults, options)));

		return _ret25 = _this25, _possibleConstructorReturn(_this25, _ret25);
	}
...
var BootstrapNavManager = function (_TemplateManager2) {
	_inherits(BootstrapNavManager, _TemplateManager2);
  ...
  */
	function BootstrapNavManager(options) {
		...
		// alias
		var _this26 = _possibleConstructorReturn(this, (BootstrapNavManager.__proto__ || Object.getPrototypeOf(BootstrapNavManager)).call(this, $Util.opts(defaults, options)));

		_this26.navs = _this26.objects;
		return _ret26 = _this26, _possibleConstructorReturn(_this26, _ret26);
	}
  ...
  */
	...
	_createClass(BootstrapNavManager, [{
		...
		value: function _create(id, data) {
			if (!isDefined(data) || !isDefined(data.href)) throw new ReferenceError("BootstrapNavManager.create: an 'href' property is required to create a Nav");else return _get2(BootstrapNavManager.prototype.__proto__ || Object.getPrototypeOf(BootstrapNavManager.prototype), "_create", this).call(this, id, data);
		}
...
var BootstrapPanel = function (_Template10) {
	_inherits(BootstrapPanel, _Template10);
  ...
  */
	function BootstrapPanel(options) {
		...
		var _this27 = _possibleConstructorReturn(this, (BootstrapPanel.__proto__ || Object.getPrototypeOf(BootstrapPanel)).call(this, $Util.opts(defaults, options)));

		var self = _this27;

		// properties
		_this27.isCollapsed = false;
		_this27.isClosed = false;

		_this27._attachHandlers();

		return _ret27 = _this27, _possibleConstructorReturn(_this27, _ret27);
	}
...
var BootstrapPanelManager = function (_TemplateManager3) {
	_inherits(BootstrapPanelManager, _TemplateManager3);
  ...
  */
	function BootstrapPanelManager(options) {
		...
		// alias
		var _this28 = _possibleConstructorReturn(this, (BootstrapPanelManager.__proto__ || Object.getPrototypeOf(BootstrapPanelManager)).call(this, $Util.opts(defaults, options)));

		_this28.panels = _this28.objects;

		return _ret28 = _this28, _possibleConstructorReturn(_this28, _ret28);
	}
...
var BootstrapCard = function (_BootstrapPanel) {
  ...
  */
	function BootstrapCard(options) {
		...
		var _this29 = _possibleConstructorReturn(this, (BootstrapCard.__proto__ || Object.getPrototypeOf(BootstrapCard)).call(this, $Util.opts(defaults, options)));

		return _ret29 = _this29, _possibleConstructorReturn(_this29, _ret29);
	}
...
var BootstrapCardManager = function (_TemplateManager4) {
	_inherits(BootstrapCardManager, _TemplateManager4);
  ...
  */
	function BootstrapCardManager(options) {
		...
		// alias
		var _this30 = _possibleConstructorReturn(this, (BootstrapCardManager.__proto__ || Object.getPrototypeOf(BootstrapCardManager)).call(this, $Util.opts(defaults, options)));

		_this30.cards = _this30.objects;

		return _ret30 = _this30, _possibleConstructorReturn(_this30, _ret30);
	}
...
var BootstrapProgress = function (_Template11) {
	_inherits(BootstrapProgress, _Template11);
  ...
  */
	function BootstrapProgress(options) {
		...
		var _this31 = _possibleConstructorReturn(this, (BootstrapProgress.__proto__ || Object.getPrototypeOf(BootstrapProgress)).call(this, $Util.opts(defaults, options)));

		_this31.percent = 0;

		return _ret31 = _this31, _possibleConstructorReturn(_this31, _ret31);
	}
...
var BootstrapLoader = function (_BootstrapProgress) {
  ...
  */
	function BootstrapLoader(options) {
		...
		// properties
		var _this32 = _possibleConstructorReturn(this, (BootstrapLoader.__proto__ || Object.getPrototypeOf(BootstrapLoader)).call(this, $Util.opts(defaults, options)));

		_this32.stepCount = _this32.settings.steps.length;
		_this32.step = 0;

		return _ret32 = _this32, _possibleConstructorReturn(_this32, _ret32);
	}
  ...
  */
   ...
   */
		...
		key: "setProgress",
		value: function setProgress(percent) {
			_get2(BootstrapLoader.prototype.__proto__ || Object.getPrototypeOf(BootstrapLoader.prototype), "setProgress", this).call(this, percent);
...
var BootstrapTab = function (_Template12) {
	_inherits(BootstrapTab, _Template12);
  ...
  */
	function BootstrapTab(options) {
		...
		var _this33 = _possibleConstructorReturn(this, (BootstrapTab.__proto__ || Object.getPrototypeOf(BootstrapTab)).call(this, $Util.opts(defaults, options)));

		return _ret33 = _this33, _possibleConstructorReturn(_this33, _ret33);
	}
...
var BootstrapTabManager = function (_TemplateManager5) {
	_inherits(BootstrapTabManager, _TemplateManager5);
  ...
  */
	function BootstrapTabManager(options) {
		...
		// alias
		var _this34 = _possibleConstructorReturn(this, (BootstrapTabManager.__proto__ || Object.getPrototypeOf(BootstrapTabManager)).call(this, $Util.opts(defaults, options)));

		_this34.tabs = _this34.objects;
		return _ret34 = _this34, _possibleConstructorReturn(_this34, _ret34);
	}
  ...
  */
	...
	_createClass(BootstrapTabManager, [{
		key: "_create",
		value: function _create(id, data) {
			if (!isDefined(data) || !isDefined(data.id)) throw new ReferenceError("BootstrapTabManager.create: an 'id' property is required to create a Tab");else return _get2(BootstrapTabManager.prototype.__proto__ || Object.getPrototypeOf(BootstrapTabManager.prototype), "_create", this).call(this, id, data);
		}
...
var BootstrapToggle = function (_Template13) {
	_inherits(BootstrapToggle, _Template13);
  ...
  */
	function BootstrapToggle(options) {
		...
		var _this35 = _possibleConstructorReturn(this, (BootstrapToggle.__proto__ || Object.getPrototypeOf(BootstrapToggle)).call(this, $Util.opts(defaults, options)));

		_this35.after = _this35._after;
		_this35.append = _this35._append;
		_this35.appendTo = _this35._appendTo;
		_this35.before = _this35._before;
		_this35.prepend = _this35._prepend;
		_this35.prependTo = _this35._prependTo;

		return _ret35 = _this35, _possibleConstructorReturn(_this35, _ret35);
	}
...
var BootstrapWizard = function (_Wizard) {
  ...
  */
	function BootstrapWizard(options) {
		...
		var _this36 = _possibleConstructorReturn(this, (BootstrapWizard.__proto__ || Object.getPrototypeOf(BootstrapWizard)).call(this, options));

		return _ret36 = _this36, _possibleConstructorReturn(_this36, _ret36);
	}
