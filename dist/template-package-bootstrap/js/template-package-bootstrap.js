...
var Form = function (_Template4) {
  ...
  */
	function Form(options) {
		...
		var _this8 = _possibleConstructorReturn(this, (Form.__proto__ || Object.getPrototypeOf(Form)).call(this, $Util.opts(defaults, options)));
...
var BootstrapControlTable = function (_ControlTable) {
  ...
  */
	function BootstrapControlTable(options) {
		...
		var _this10 = _possibleConstructorReturn(this, (BootstrapControlTable.__proto__ || Object.getPrototypeOf(BootstrapControlTable)).call(this, options));
...
var BootstrapFeedback = function (_Feedback) {
  ...
  */
	function BootstrapFeedback(options) {
		...
		var _this11 = _possibleConstructorReturn(this, (BootstrapFeedback.__proto__ || Object.getPrototypeOf(BootstrapFeedback)).call(this, options));

		var self = _this11;

		if (_this11.settings.closeButton) {
			_this11.$close.click(function () {
				self.slideUp();
			});
		}
  ...
  */
	...
	_createClass(BootstrapFeedback, [{
		...
		value: function _useDefaultTemplate() {
			var template = '';
			if (this.settings.closeButton) {
				template = '<div class="feedback alert clearfix">' + '<div class="col-sm-offset-1 col-sm-10">' + '<div class="feedback-icon"></div>' + '<div class="feedback-text"></div>' + '</div>' + '<div class="col-sm-1">' + '<button type="button" name="close" class="close">&times;</button>' + '</div>' + '</div>';
			} else {
...
var BootstrapForm = function (_Form2) {
  ...
  */
	function BootstrapForm(options) {
		...
		var _this12 = _possibleConstructorReturn(this, (BootstrapForm.__proto__ || Object.getPrototypeOf(BootstrapForm)).call(this, options));
...
var BootstrapModal = function (_Template5) {
	_inherits(BootstrapModal, _Template5);
  ...
  */
	function BootstrapModal(options) {
		...
		var _this13 = _possibleConstructorReturn(this, (BootstrapModal.__proto__ || Object.getPrototypeOf(BootstrapModal)).call(this, $Util.opts(defaults, options)));
...
var BootstrapModalForm = function (_BootstrapModal) {
  ...
  */
	function BootstrapModalForm(options) {
		...
		// properties
		var _this14 = _possibleConstructorReturn(this, (BootstrapModalForm.__proto__ || Object.getPrototypeOf(BootstrapModalForm)).call(this, options));
...
var BootstrapNav = function (_Template6) {
	_inherits(BootstrapNav, _Template6);
  ...
  */
	function BootstrapNav(options) {
		...
		var _this15 = _possibleConstructorReturn(this, (BootstrapNav.__proto__ || Object.getPrototypeOf(BootstrapNav)).call(this, $Util.opts(defaults, options)));
...
var BootstrapNavManager = function (_TemplateManager) {
  ...
  */
	function BootstrapNavManager(options) {
		...
		// alias
		var _this16 = _possibleConstructorReturn(this, (BootstrapNavManager.__proto__ || Object.getPrototypeOf(BootstrapNavManager)).call(this, $Util.opts(defaults, options)));

		_this16.navs = _this16.objects;
...
var BootstrapPanel = function (_Template7) {
	_inherits(BootstrapPanel, _Template7);
  ...
  */
	function BootstrapPanel(options) {
		...
		var _this17 = _possibleConstructorReturn(this, (BootstrapPanel.__proto__ || Object.getPrototypeOf(BootstrapPanel)).call(this, $Util.opts(defaults, options)));

		var self = _this17;

		// properties
		_this17.isCollapsed = false;
		_this17.isClosed = false;

		_this17._attachHandlers();
...
var BootstrapPanelManager = function (_TemplateManager2) {
  ...
  */
	function BootstrapPanelManager(options) {
		...
		// alias
		var _this18 = _possibleConstructorReturn(this, (BootstrapPanelManager.__proto__ || Object.getPrototypeOf(BootstrapPanelManager)).call(this, $Util.opts(defaults, options)));

		_this18.panels = _this18.objects;
...
var BootstrapCard = function (_BootstrapPanel) {
  ...
  */
	function BootstrapCard(options) {
		...
		var _this19 = _possibleConstructorReturn(this, (BootstrapCard.__proto__ || Object.getPrototypeOf(BootstrapCard)).call(this, $Util.opts(defaults, options)));
...
var BootstrapCardManager = function (_TemplateManager3) {
  ...
  */
	function BootstrapCardManager(options) {
		...
		// alias
		var _this20 = _possibleConstructorReturn(this, (BootstrapCardManager.__proto__ || Object.getPrototypeOf(BootstrapCardManager)).call(this, $Util.opts(defaults, options)));

		_this20.cards = _this20.objects;
...
var BootstrapProgress = function (_Template8) {
	_inherits(BootstrapProgress, _Template8);
  ...
  */
	function BootstrapProgress(options) {
		...
		var _this21 = _possibleConstructorReturn(this, (BootstrapProgress.__proto__ || Object.getPrototypeOf(BootstrapProgress)).call(this, $Util.opts(defaults, options)));
...
var BootstrapLoader = function (_BootstrapProgress) {
  ...
  */
	function BootstrapLoader(options) {
		...
		// properties
		var _this22 = _possibleConstructorReturn(this, (BootstrapLoader.__proto__ || Object.getPrototypeOf(BootstrapLoader)).call(this, $Util.opts(defaults, options)));

		_this22.stepCount = _this22.settings.steps.length;
		_this22.step = 0;
...
var BootstrapTab = function (_Template9) {
	_inherits(BootstrapTab, _Template9);
  ...
  */
	function BootstrapTab(options) {
		...
		var _this23 = _possibleConstructorReturn(this, (BootstrapTab.__proto__ || Object.getPrototypeOf(BootstrapTab)).call(this, $Util.opts(defaults, options)));
...
var BootstrapTabManager = function (_TemplateManager4) {
  ...
  */
	function BootstrapTabManager(options) {
		...
		// alias
		var _this24 = _possibleConstructorReturn(this, (BootstrapTabManager.__proto__ || Object.getPrototypeOf(BootstrapTabManager)).call(this, $Util.opts(defaults, options)));

		_this24.tabs = _this24.objects;
...
var BootstrapToggle = function (_Template10) {
	_inherits(BootstrapToggle, _Template10);
  ...
  */
	function BootstrapToggle(options) {
		...
		var _this25 = _possibleConstructorReturn(this, (BootstrapToggle.__proto__ || Object.getPrototypeOf(BootstrapToggle)).call(this, $Util.opts(defaults, options)));

		_this25.after = _this25._after;
		_this25.append = _this25._append;
		_this25.appendTo = _this25._appendTo;
		_this25.before = _this25._before;
		_this25.prepend = _this25._prepend;
		_this25.prependTo = _this25._prependTo;
...
var BootstrapWizard = function (_Wizard) {
  ...
  */
	function BootstrapWizard(options) {
		...
		var _this26 = _possibleConstructorReturn(this, (BootstrapWizard.__proto__ || Object.getPrototypeOf(BootstrapWizard)).call(this, options));
