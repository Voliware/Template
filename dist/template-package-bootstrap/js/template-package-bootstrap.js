 ...
 */var BootstrapFeedback=function(_Feedback){_inherits(BootstrapFeedback,_Feedback);/**
	 ...
	 * @returns {BootstrapFeedback}
	 * @private
	 */_createClass(BootstrapFeedback,[{key:"_useDefaultTemplate",value:function _useDefaultTemplate(){var template='';if(this.settings.closeButton){template='<div class="feedback alert clearfix">'+'<div class="col-xs-offset-1 col-xs-10 col-sm-offset-1 col-sm-10">'+'<span class="feedback-icon"></span>'+'<span class="feedback-text"></span>'+'</div>'+'<div class="col-xs-1 col-sm-1">'+'<button type="button" name="close" class="close">&times;</button>'+'</div>'+'</div>';}else{template='<div class="feedback alert clearfix">'+'<div class="col-12">'+'<span class="feedback-icon"></span>'+'<span class="feedback-text"></span>'+'</div>'+'</div>';}this._useTemplate($(template));this.$wrapper.hide();return this;}/**
