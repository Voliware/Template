...
var BootstrapToggle = function (_Template) {
	_inherits(BootstrapToggle, _Template);
  ...
  */
	function BootstrapToggle(options) {
		...
		var _this = _possibleConstructorReturn(this, (BootstrapToggle.__proto__ || Object.getPrototypeOf(BootstrapToggle)).call(this, $Util.opts(defaults, options)));

		_this.after = _this._after;
		_this.append = _this._append;
		_this.appendTo = _this._appendTo;
		_this.before = _this._before;
		_this.prepend = _this._prepend;
		_this.prependTo = _this._prependTo;
...
var BootstrapProgress = function (_Template2) {
	_inherits(BootstrapProgress, _Template2);
  ...
  */
	function BootstrapProgress(options) {
		...
		var _this3 = _possibleConstructorReturn(this, (BootstrapProgress.__proto__ || Object.getPrototypeOf(BootstrapProgress)).call(this, $Util.opts(defaults, options)));
...
var BootstrapLoader = function (_BootstrapProgress) {
  ...
  */
	function BootstrapLoader(options) {
		...
		var _this4 = _possibleConstructorReturn(this, (BootstrapLoader.__proto__ || Object.getPrototypeOf(BootstrapLoader)).call(this, $Util.opts(defaults, options)));

		_this4.stepCount = _this4.settings.steps.length;
		_this4.step = 0;
  ...
  */
   ...
   */
		...
		key: 'setErr',
		value: function setErr(id) {
			// if no id, set current step into error
			if (!isDefined(id)) id = this.step;
			var step = this._getStep(id);
...
var BootstrapModal = function (_Template3) {
	_inherits(BootstrapModal, _Template3);
  ...
  */
	function BootstrapModal(options) {
		...
		var _this5 = _possibleConstructorReturn(this, (BootstrapModal.__proto__ || Object.getPrototypeOf(BootstrapModal)).call(this, $Util.opts(defaults, options)));
...
var BootstrapNav = function (_Template4) {
	_inherits(BootstrapNav, _Template4);
...
var BootstrapTab = function (_Template5) {
  ...
  */
	function BootstrapTab(options) {
		...
		var _this8 = _possibleConstructorReturn(this, (BootstrapTab.__proto__ || Object.getPrototypeOf(BootstrapTab)).call(this, $Util.opts(defaults, options)));
...
var BootstrapTabManager = function (_TemplateManager2) {
	_inherits(BootstrapTabManager, _TemplateManager2);
  ...
  */
	function BootstrapTabManager(options) {
		...
		// alias
		var _this9 = _possibleConstructorReturn(this, (BootstrapTabManager.__proto__ || Object.getPrototypeOf(BootstrapTabManager)).call(this, $Util.opts(defaults, options)));

		_this9.tabs = _this9.objects;
...
var BootstrapPanel = function (_Template6) {
	_inherits(BootstrapPanel, _Template6);
  ...
  */
	function BootstrapPanel(options) {
		...
		var _this10 = _possibleConstructorReturn(this, (BootstrapPanel.__proto__ || Object.getPrototypeOf(BootstrapPanel)).call(this, $Util.opts(defaults, options)));

		var self = _this10;

		// properties
		_this10.isCollapsed = false;
		_this10.isClosed = false;

		// handlers
		if (_this10.settings.closeable) {
			_this10.$close.click(function (e) {
				e.stopPropagation();
				self._onClose();
				self.trigger('close');
			});
		}
		if (_this10.settings.collapsible) {
			_this10.$header.click(function () {
				self._collapse();
...
var BootstrapPanelManager = function (_TemplateManager3) {
  ...
  */
	function BootstrapPanelManager(options) {
		...
		// alias
		var _this11 = _possibleConstructorReturn(this, (BootstrapPanelManager.__proto__ || Object.getPrototypeOf(BootstrapPanelManager)).call(this, $Util.opts(defaults, options)));

		_this11.panels = _this11.objects;
